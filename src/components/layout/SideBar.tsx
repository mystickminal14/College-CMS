...
const menuItems: MenuItem[] = [
  ...
  // { id: "routine", icon: MdClass, label: "Class Routine", badge: "New" },
  // { id: "admit-card", icon: MdPerson, label: "Admit Card", badge: "New" },
  // { id: "dcr", icon: MdAssignment, label: "Daily Class Report", badge: "New" },
  // { id: "calender", icon: MdCalendarToday, label: "Calender", badge: "New" },
  // { id: "fee", icon: MdAttachMoney, label: "Fees", badge: "New" },
  // {
  //   id: "notice",
  //   icon: MdNotifications,
  //   label: "Notice Board",
  //   subMenus: [
  //     { id: "notice-item", label: "Notice" },
  //     { id: "email", label: "E-mail" },
  //     { id: "sms", label: "SMS" },
  //   ],
  // },
  // { id: "application", icon: MdCalendarToday, label: "File Application", badge: "New" },
  // { id: "profile", icon: MdPerson, label: "Profile", badge: "New" },
  // { id: "download", icon: FaFileDownload, label: "Download Forms", badge: "New" },
];
...
const SideBar: React.FC<SideBarProps> = ({ collapsed, onCollapse, profile, isLoading }) => {
  ...
  return (
    <div
      className={`font-poppins flex flex-col relative z-10 
