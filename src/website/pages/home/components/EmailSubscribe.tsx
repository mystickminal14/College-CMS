...
import background from "../../../../assets/white_bg.webp";
    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-10 px-6 text-center text-white">
        ...
        <p className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto mb-10">
          Have questions about courses, eligibility, or admission process?
          Enquire now and our team will assist you.
        </p>
        ...
        >
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-14 pr-6 py-5 border-2 border-white/40 rounded-full
                         text-white placeholder-white/70 bg-transparent
          ...
          <button
            ...
            className="px-12 py-5 bg-white text-[#474AFF] font-bold text-lg
