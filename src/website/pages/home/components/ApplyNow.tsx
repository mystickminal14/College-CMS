      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-12 ">
        ...
        <div className="text-center  lg:text-left flex-1 relative">
          ...
          <div className="mt-10 flex flex-row gap-4 justify-center  apply-button">
            <a
              href="#"
              className="inline-flex uppercase items-center justify-center text-[12px] sm:text-[18px] rounded-full bg-[#474AFF] px-5 sm:px-12 py-4 text-white font-medium transition hover:bg-[#2535c7] shadow-lg"
            >
              Contact Us
            </a>
            <a
