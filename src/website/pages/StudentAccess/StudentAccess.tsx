        ...
        <section className="mb-20">
          ...
          >
            ...
            <motion.div 
              ...
              className="bg-linear-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 md:p-8 mb-12"
            >
              ...
              >
                <motion.a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-6 py-3 bg-linear-to-r from-blue-600 to-blue-700 text-white font-medium rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-md hover:shadow-lg"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <motion.svg 
            ...
            >
              ...
              <p className="text-gray-600">
                ...
                <a href="mailto:library@apu.edu.my" className="text-blue-600 hover:text-blue-800 ml-1">
                  library@apu.edu.my
                </a>
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <motion.a 
                    href="mailto:itsupport@apu.edu.my" 
                    className="text-blue-600 hover:text-blue-800 font-medium"
                    whileHover={{ x: 5 }}
                  >
                    itsupport@apu.edu.my
                  </motion.a>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  ...
                  <motion.a 
                    href="mailto:library@apu.edu.my" 
                    className="text-blue-600 hover:text-blue-800 font-medium"
                    whileHover={{ x: 5 }}
                  >
                    library@apu.edu.my
