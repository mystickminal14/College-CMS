  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <HeroTitleWithGif
        ...
        highlightedText="Contact List"
        subtitle="Find the right contact for academic matters, IT support, exams, registration, accounts, and other student services."
        badgeText="Contact Directory"
      />
