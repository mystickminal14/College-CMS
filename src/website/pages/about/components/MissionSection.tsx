  ...
  return (
    <section className="relative w-full min-h-screen bg-white overflow-hidden">
      ...
      <div
        ...
        "
      >
        <Diamond src={top_mission} className="absolute top-[8%] right-[35%]" />
        <Diamond src={middle_mission} className="absolute top-[34%] right-[60%]" />
        <Diamond src={bottom_mission} className="absolute top-[60%] right-[35%]" />

        <img
          src={half_diamond}
          alt=""
          className="absolute right-0 top-1/2 -translate-y-1/2
                     w-40 md:w-[220px] lg:w-[280px]"
        />
      </div>
    </section>
  );
