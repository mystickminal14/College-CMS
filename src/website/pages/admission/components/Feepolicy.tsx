      ...
      <div className="bg-red-50 border border-red-100 rounded-lg p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row items-start gap-2 sm:gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
           Security deposit made by students will not be liable to be returned if a student discontinues his/her academic pursuit before the couse completion. For students successfully completing the course, the security deposit amount will be returned at the end of the course </p>
          </div>
        </div>
      </div>
    </div>
