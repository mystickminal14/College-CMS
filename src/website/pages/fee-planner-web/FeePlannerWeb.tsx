      ...
      <div className="container mx-auto sm:px-6 lg:px-8 py-4 md:py-20 text-center">
        ...
        >
          ...
          <p className="text-sm md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Plan your fee journey with our comprehensive curriculum structure.
            Explore different sessions and their corresponding fee plans.
          </p>
        </motion.div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-16 lg:px-16 pb-12 md:pb-20">
        {isLoading ? (
          ...
          data.data.map((parent) => {
            ...
            const lastWord = sessionWords.at(-1) || '';
