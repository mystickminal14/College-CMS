      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <HeroTitleWithGif
            ...
            subtitle="Guidelines and expectations for student behavior to maintain a respectful and productive learning environment."
            badgeText="Student Code of Conduct"
          />
