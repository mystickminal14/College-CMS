...
const DeletePopupModal: React.FC<Props> = ({ isOpen, onClose, popup }) => {
        ...
        >
          ...
          <div className="bg-red-600 p-6 flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Delete Popup</h2>
            ...
            <div className="mb-6">
              ...
              <div className="text-center mb-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Delete <span className="text-red-600">"{popup.title}"</span>?
                </h3>
