...
import useDeleteConnects from "../hooks/useDelete";
...
const DeleteConnectsModal: React.FC<Props> = ({ isOpen, onClose, connect }) => {
  const mutation = useDeleteConnects();
    if (!isOpen || !connect) return null;
            ...
            <div className="mb-6">
              ...
              <div className="text-center mb-2">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Delete <span className="text-red-600">{connect.volume} {connect.issue} </span>?
                </h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  This Connects will be permanently deleted from the system.
                </p>
              </div>
...
export default DeleteConnectsModal;