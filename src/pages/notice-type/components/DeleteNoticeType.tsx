...
const DeleteNoticeTypeModal: React.FC<Props> = ({
  isOpen,
  onClose,
  noticeType,
  onConfirm,
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-md overflow-hidden">
        <div className="bg-red-600 p-5 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-white">Delete Notice Type</h2>
          </div>
        ...
        <div className="p-6 text-sm text-gray-700 dark:text-gray-300">
          ...
          <span className="font-semibold">{noticeType.name}</span>? Types still
          assigned to a notice cannot be deleted — reassign those notices first.
        </div>
...
export default DeleteNoticeTypeModal;
