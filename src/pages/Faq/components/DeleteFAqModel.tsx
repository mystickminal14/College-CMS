...
const DeleteFaqModal: React.FC<Props> = ({ isOpen, onClose, faq }) => {
  const mutation = useDeleteFaq();
        ...
        >
          ...
          <div className="bg-red-600 p-6 flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Delete FAQ</h2>
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-5">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                Delete <span className="text-red-600">FAQ #{faq.order}</span>?
              </h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm mt-2 line-clamp-2">
                "{faq.questions}"
              </p>
              <p className="text-gray-500 dark:text-gray-400 text-sm mt-3">
                The question and its answer will be permanently removed.
              </p>
            </div>
            ...
            <div className="flex space-x-3">
              ...
              <button
                type="submit"
                disabled={mutation.isPending}
                className="flex-1 px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {mutation.isPending ? (
                  <>
