...
interface Props {
  ...
  onClose: () => void;
  type?: CourseCategory;
  isEdit?: boolean;mutation?: UseMutationResult<ApiResponse<CourseCategory>, ApiErrorResponse  , CourseCategory>;
    editMutation?: UseMutationResult<ApiResponse<CourseCategory>, ApiErrorResponse, Partial<CourseCategory> & { id: number }>;
    
}


const AddEditCourseCategoryModal: React.FC<Props> = ({
  isOpen,
  onClose,
  type,
  isEdit = false,
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold">
            {isEdit ? "Edit Course Category Name" : "Add Course Category Name"}
          </h2>
...
export default AddEditCourseCategoryModal;
