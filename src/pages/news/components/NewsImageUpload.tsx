...
interface NewsImageUploadFormProps {
  newsName: string;
...
const NewsImageUploadForm: React.FC<NewsImageUploadFormProps> = ({
  newsName,
  imagePreview,
  imageFile,
  onImageChange,
    ...
    <div className="space-y-6">
      <div className="text-center mb-2">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
          {imagePreview ? "Current Image / Upload New" : "Upload News Photo"}
        </h3>
        <p className="text-gray-600 dark:text-gray-300">
          {imagePreview ? `Current image for ${newsName}` : `Add an image for ${newsName}`}
        </p>
      </div>
...
export default NewsImageUploadForm;
