      ...
      createMutation.mutate(formData, {
        onSuccess: (res) => {
          ...
          if (newId) {
            ...
            appContext?.showToast("Failed to create news. No ID returned.", "error");
          }
        },
      });
    }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/90 text-sm">
                {step === 1 ? "Step 1: Basic Info" : "Step 2: Upload Image"}
              </p>
            </div>
          </div>
          <button
          ...
          {step === 1 ? (
            <form onSubmit={handleSubmitStep1} className="space-y-6">
              ...
              <div className="flex gap-3">
                <button
                  type="submit"
                  className="flex-1 py-3.5 bg-[#135EAB] text-white rounded-xl font-medium"
                >
