...
import useToggleGalleryTypeStatus from "../hooks/useToggleStatus";
import type { GalleryType } from "../model/GallModel";

interface Props {
  isOpen: boolean;
  onClose: () => void;
  contact: GalleryType | null;
}

const ToggleStatusModel: React.FC<Props> = ({
  isOpen,
  onClose,
  contact,
}) => {
  const mutation = useToggleGalleryTypeStatus();
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">
                  {isEnabled ? "Deactivate Gallery" : "Activate Gallery"}
                </h2>
