...
import { useDeleteGalleryType } from "../../hooks/type/useDelete";
...
const DeleteGalleryTypeModal: React.FC<Props> = ({ isOpen, onClose, type }) => {
  const deleteMutation = useDeleteGalleryType();
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-red-600">Delete Gallery Type</h2>
        ...
        <p className="mb-4 text-sm text-gray-700 dark:text-gray-300">
          Are you sure you want to delete <strong>{type.name}</strong>?<br />
          All photos under this type will also be deleted permanently.
        </p>
