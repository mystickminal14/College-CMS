...
import useDeleteAchivement from "../hooks/useDelete";
...
const DeleteAchivementModal: React.FC<Props> = ({ isOpen, onClose, achivement }) => {
  const mutation = useDeleteAchivement();
    if (!isOpen || !achivement) return null;
        ...
        >
          ...
          <div className="bg-red-600 p-6 flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Delete Achivement</h2>
            ...
            <div className="mb-6">
              ...
              <div className="text-center mb-2">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Delete <span className="text-red-600">{achivement.achivement}</span>?
                </h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  This achivement will be permanently deleted from the system.
                </p>
              </div>
...
export default DeleteAchivementModal;