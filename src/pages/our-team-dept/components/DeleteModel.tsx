...
const DeleteCoursesModal: React.FC<Props> = ({ isOpen, onClose, course }) => {
            ...
            <div className="mb-6">
              ...
              <div className="text-center mb-2">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Delete <span className="text-red-600">{course.title } </span>?
                </h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  This Courses will be permanently deleted from the system.
                </p>
              </div>
