...
interface AlumniImageUploadFormProps {
  alumniName: string;
...
const AlumniImageUploadForm: React.FC<AlumniImageUploadFormProps> = ({
  alumniName,
  imagePreview,
  imageFile,
  onImageChange,
    ...
    <div className="space-y-6">
      <div className="text-center mb-2">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          {imagePreview ? `Current image for ${alumniName}` : `Add a professional photo for ${alumniName}`}
        </p>
      </div>
...
export default AlumniImageUploadForm;
