...
import useDeleteAlumni from "../hooks/useDeleteAlumni";
...
const DeleteAlumniModal: React.FC<Props> = ({ isOpen, onClose, alumni }) => {
  const mutation = useDeleteAlumni();
        ...
        >
          ...
          <div className="bg-red-600 p-6 flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Delete Alumni</h2>
            ...
            <div className="mb-6">
              ...
              <div className="text-center mb-2">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Delete <span className="text-red-600">{alumni.name}</span>?
                </h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  This alumni will be permanently deleted from the system.
                </p>
              </div>
