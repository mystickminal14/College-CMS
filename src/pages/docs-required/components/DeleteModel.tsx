...
import useDeleteDocuments from "../hooks/useDeleteDocs";
...
const DeleteDocumentsModal: React.FC<Props> = ({ isOpen, onClose, document }) => {
  const mutation = useDeleteDocuments();
            ...
            <div className="mb-6">
              ...
              <div className="text-center mb-2">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Delete <span className="text-red-600">{document.type } </span>?
                </h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  This Documents will be permanently deleted from the system.
                </p>
              </div>
