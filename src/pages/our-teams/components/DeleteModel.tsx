...
import useDeleteTeams from "../hooks/useDelete";
...
const DeleteTeamsModal: React.FC<Props> = ({ isOpen, onClose, Teams }) => {
  const mutation = useDeleteTeams();
            ...
            <div className="mb-6">
              ...
              <div className="text-center mb-2">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Delete <span className="text-red-600">{Teams.name}</span>?
                </h3>
