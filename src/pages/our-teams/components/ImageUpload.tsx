...
interface TeamImageUploadFormProps {
  teamName: string;
...
const TeamImageUploadForm: React.FC<TeamImageUploadFormProps> = ({
  teamName,
  imagePreview,
  imageFile,
  onImageChange,
    ...
    <div className="space-y-6">
      <div className="text-center mb-2">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          {imagePreview ? `Current image for ${teamName}` : `Add a professional photo for ${teamName}`}
        </p>
      </div>
