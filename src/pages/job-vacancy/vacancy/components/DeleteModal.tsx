...
import useDeleteVacancy from "../hooks/useDelete";
...
const DeleteVacancyModal: React.FC<Props> = ({ isOpen, onClose, vacancy }) => {
  const mutation = useDeleteVacancy();
  if (!isOpen || !vacancy) return null;

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    mutation.mutate({ id: vacancy.id }, { onSuccess: onClose });
  };
        ...
        >
          <div className="bg-red-600 p-6 flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Delete Vacancy</h2>
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                Delete <span className="text-red-600">{vacancy.designation}</span>?
              </h3>
              <p className="text-gray-600 dark:text-gray-300 mt-2 text-sm">
                This vacancy and all its applications will be permanently deleted.
              </p>
            </div>
            ...
            <div className="flex space-x-3 mt-6">
              ...
              <button
                type="submit"
                disabled={mutation.isPending}
                className="flex-1 px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium flex items-center justify-center disabled:opacity-50"
              >
                {mutation.isPending ? (
                  <>
