...
import useDeleteApplicant from "../hooks/useDelete";
...
const DeleteApplicantModal: React.FC<Props> = ({ isOpen, onClose, applicant }) => {
  const mutation = useDeleteApplicant();
  if (!isOpen || !applicant) return null;

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    mutation.mutate({ id: applicant.id }, { onSuccess: onClose });
  };
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                Delete application by <span className="text-red-600">{applicant.fullName}</span>?
              </h3>
