...
import useDeleteNotices from "../hooks/useDelete";
...
const DeleteNoticesModal: React.FC<Props> = ({ isOpen, onClose, Notices }) => {
  const mutation = useDeleteNotices();
    if (!isOpen || !Notices) return null;
            ...
            <div className="mb-6">
              ...
              <div className="text-center mb-2">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Delete <span className="text-red-600">{Notices.program_name}</span>?
                </h3>
