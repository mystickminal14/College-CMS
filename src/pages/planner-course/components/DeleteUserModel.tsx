...
import useDeletePlannerCourse from "../hooks/useDeleteUser";
import type { PlannerCourse } from "../model/PlannerCourse";

interface Props {
  isOpen: boolean;
  onClose: () => void;
  plannercourse: PlannerCourse | null;
}

const DeletePlannerCourseModal: React.FC<Props> = ({ isOpen, onClose, plannercourse }) => {
  const mutation = useDeletePlannerCourse();
    if (!isOpen || !plannercourse) return null;
            ...
            <div className="mb-6">
              ...
              <div className="text-center mb-2">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Delete <span className="text-red-600">{plannercourse.name}</span>?
                </h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  This course will be permanently deleted from the system.
                </p>
              </div>
...
export default DeletePlannerCourseModal;