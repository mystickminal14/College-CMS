...
const EditScholarshipModal = ({ isOpen, onClose, data, mutation }: Props) => {
  const [form, setForm] = useState<ScholarshipSchedule | null>(null);
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl w-full max-w-2xl p-6">
        ...
        >
          ...
          <InputField
            ...
            field="regisrationOpenDate"
            value={form.regisrationOpenDate}
            onChange={handleFieldChange}
            required
          />
          ...
          <div className="col-span-full flex justify-end gap-3 pt-4">
            ...
            <button
              ...
              className="px-6 py-2 bg-[#1a7cd3] text-white rounded-lg hover:bg-[#0f4a8c] disabled:opacity-60"
            >
