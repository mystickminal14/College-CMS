...
interface Props {
  ...
  type?: VisitPurpose;
  isEdit?: boolean;
  mutation?: UseMutationResult<ApiResponse<VisitPurpose>, ApiErrorResponse, VisitPurpose>;
...
const AddEditVisitPurposeModal: React.FC<Props> = ({
  isOpen,
  onClose,
  type,
  isEdit = false,
  ...
  if (isEdit && type?.isOther) return null;
...
export default AddEditVisitPurposeModal;
