...
interface Props {
  ...
  editMutation?: UseMutationResult<any, any, UpdateFeeYearPayload>;
}
...
const AddEditFeeYearModal: React.FC<Props> = ({
  isOpen,
  onClose,
  type,
  isEdit = false,
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold">
            {isEdit ? "Edit Fee Year" : "Add Fee Year"}
          </h2>
        ...
        >
          ...
          {isEdit ? "Update Fee Year" : "Add Fee Year"}
        </button>
      </form>
    </div>
  );
...
export default AddEditFeeYearModal;
